...
export default function GraficoTotalCompras({ yearsOptions, fetchData }) {
    ...
    const optionsFilter = [{ name: 'Productos Vendidos', value: 'cantidad_vendidos' }, { name: 'Productos Comprados', value: 'cantidad_compras' }]

    //suma los totales de cada categoria
    ...
    return (
        <>
            <div className="flex justify-between">
                <div className="font-medium line-height-4">Cantidad total de {optionFilterName} Por Categoria</div>
