...
const rev_config = () => {
    const config = typeof window !== 'undefined' ? window.localStorage.getItem('config') : null;
...
const AppConfig = (props) => {
    ...
    const [isConfig, setIsConfig] = useState(rev_config());
    const ref_but = useRef(null)
    ...
    useEffect(() => {
        ...
        if (!isConfig) ref_but.current.click();
    ...
    const decrementScale = () => {
        const nuevaEscala = layoutConfig.scale - 1;
        save_storage('escala', nuevaEscala);
        ...
        <div id="layout-config">
            ...
            >
                ...
                <div className="field-radiobutton">
                    ...
                    <label htmlFor="theme3">Modo Claro</label>
                </div>
                ...
                <div className="field-radiobutton">
                    ...
                    <label htmlFor="theme1">Modo oscuro</label>
                </div>
