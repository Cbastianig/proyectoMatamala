...
const Layout = (props) => {
    const { layoutConfig, layoutState, setLayoutState, isSlim, isSlimPlus, isHorizontal, isDesktop, path } = useContext(LayoutContext);
    ...
    return (
        <div className={classNames('layout-container', containerClassName)} data-theme={layoutConfig.colorScheme}>
            ...
            <div className="layout-content-wrapper">
                <AppTopbar path={path} ref={topbarRef} sidebarRef={sidebarRef} />
